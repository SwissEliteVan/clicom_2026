...
CATÉGORIE: `44-TESTING`

PÉRIMÈTRE
Selon la stack : lint, typecheck, unit, integration, E2E, build, liens, formulaires, navigation, SEO, accessibilité, responsive et runtime. Vérifier que les tests annoncés ont réellement été exécutés. Détecter les commandes inexistantes. Enregistrer les versions des outils. Relier chaque exigence testable à un test pertinent. Ne jamais masquer un vrai échec.
...
- `.md-ai-system/state/44-TESTING.json`
