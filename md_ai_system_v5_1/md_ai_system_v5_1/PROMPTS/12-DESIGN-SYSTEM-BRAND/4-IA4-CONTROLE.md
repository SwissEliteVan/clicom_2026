...
CATÉGORIE: `12-DESIGN-SYSTEM-BRAND`

PÉRIMÈTRE
Définir tokens, couleurs, typo, spacing, grilles, boutons, composants, états, règles de composition, usages média et motion, responsive et règles anti-template. Le design doit découler du positionnement et de l'art direction, pas d'un template générique.
...
- `.md-ai-system/state/12-DESIGN-SYSTEM-BRAND.json`
