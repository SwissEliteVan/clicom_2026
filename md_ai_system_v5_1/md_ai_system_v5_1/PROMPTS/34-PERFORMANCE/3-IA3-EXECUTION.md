...
CATÉGORIE: `34-PERFORMANCE`

PÉRIMÈTRE
Contrôler LCP, CLS, INP, poids JS, images, vidéos, fonts, preload, lazy loading, responsive images, cache, hydratation, code splitting et mobile. Respecter tout budget chiffré documenté. Lighthouse réel au moment logique, typiquement staging.

DÉPENDANCES RÉELLES
17-MEDIA-HERO-IMAGES-BLOG, 33-DEPENDENCY-AUDIT
...
- `.md-ai-system/state/34-PERFORMANCE.json`
