...
PÉRIMÈTRE
Selon les `.md` : title, meta, canonical, robots, sitemap, Open Graph, Twitter/X cards si utiles, Schema.org, breadcrumbs, hreflang, URLs, redirections, 404, maillage, indexation, ALT, duplication technique.

DÉPENDANCES RÉELLES
16-CONTENT-BLOG, 17-MEDIA-HERO-IMAGES-BLOG
...
- `.md-ai-system/state/29-SEO.json`
