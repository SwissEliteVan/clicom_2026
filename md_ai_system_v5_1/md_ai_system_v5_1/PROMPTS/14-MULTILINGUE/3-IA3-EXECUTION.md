...
CATÉGORIE: `14-MULTILINGUE`

PÉRIMÈTRE
Si demandé : textes centralisés, routes/locales, sélecteur de langue, métadonnées, hreflang, canonical, OG si nécessaire, formulaires/messages traduits. L'ajout d'une langue ne doit pas nécessiter une refonte.
...
- `.md-ai-system/state/14-MULTILINGUE.json`
