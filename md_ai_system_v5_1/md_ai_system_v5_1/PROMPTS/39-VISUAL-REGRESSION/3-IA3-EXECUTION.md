...
CATÉGORIE: `39-VISUAL-REGRESSION`

PÉRIMÈTRE
Après changements UI/média : comparer les écrans critiques desktop/mobile aux références validées. Détecter régressions de layout, typo, espacements, couleurs, assets et animations, ainsi que dérive par rapport à l'art direction.

DÉPENDANCES RÉELLES
37-RESPONSIVE, 12-DESIGN-SYSTEM-BRAND
...
- `.md-ai-system/state/39-VISUAL-REGRESSION.json`
