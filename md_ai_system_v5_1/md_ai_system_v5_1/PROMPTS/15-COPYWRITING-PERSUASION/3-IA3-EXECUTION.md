# COPYWRITING / PERSUASION / PREUVE

ÉTAPE: `3-IA3-EXECUTION.md`
CATÉGORIE: `15-COPYWRITING-PERSUASION`

PÉRIMÈTRE
Structurer les pages commerciales : hiérarchie du message, bénéfices, objections, crédibilité, CTA, FAQ, microcopy, ton et différenciation du discours. Utiliser uniquement des preuves réelles et documentées. Interdire bénéfices, chiffres, témoignages, clients ou résultats inventés.

DÉPENDANCES RÉELLES
11-MARKETING-BRAND-DIFFERENTIATION
...
- `.md-ai-system/state/15-COPYWRITING-PERSUASION.json`
