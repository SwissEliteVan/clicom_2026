# CRM / CYCLE DE VIE DU LEAD

ÉTAPE: `2-IA2-VERIFICATION.md`
CATÉGORIE: `20-CRM-LEAD-LIFECYCLE`

PÉRIMÈTRE
Si applicable : lead entrant, source, qualification, statut, relance, nurturing email, CRM, attribution, passage MQL/SQL si pertinent, relance après formulaire/réservation/WhatsApp/abandon, consentement et journalisation des transitions.

DÉPENDANCES RÉELLES
19-COMMERCIAL-FUNNEL-CONVERSION
...
- `.md-ai-system/state/20-CRM-LEAD-LIFECYCLE.json`
