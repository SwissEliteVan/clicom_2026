...
PÉRIMÈTRE
Si demandé : pipeline réel pour main, checks, cache, artefacts utiles, secrets, environnements, build/test et déploiement. Ne jamais créer de branche.
...
- `.md-ai-system/state/45-CI-CD.json`
