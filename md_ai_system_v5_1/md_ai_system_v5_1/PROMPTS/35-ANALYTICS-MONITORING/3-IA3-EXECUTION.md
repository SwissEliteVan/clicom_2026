...
CATÉGORIE: `35-ANALYTICS-MONITORING`

PÉRIMÈTRE
Seulement si demandé : analytics, événements CTA/formulaires/rendez-vous/WhatsApp/conversions, consentement, erreurs, logs, monitoring et alertes. Aucun événement non autorisé par consentement lorsque requis.

DÉPENDANCES RÉELLES
27-COOKIE-CONSENT-PRIVACY, 28-ATTRIBUTION-TRACKING
...
- `.md-ai-system/state/35-ANALYTICS-MONITORING.json`
