...
CATÉGORIE: `04-ARCHITECTURE`

PÉRIMÈTRE
Définir et implémenter dossiers, routes, composants, modules, services, états, erreurs, logging, variables d'environnement, feature flags si applicables et intégrations. Éviter surarchitecture et duplication.
...
- `.md-ai-system/state/04-ARCHITECTURE.json`
