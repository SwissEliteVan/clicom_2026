...
CATÉGORIE: `36-HEALTH-UPTIME`

PÉRIMÈTRE
Si backend ou service critique : health checks, readiness/liveness si pertinent, uptime monitoring, alertes et dépendances critiques.
...
- `.md-ai-system/state/36-HEALTH-UPTIME.json`
