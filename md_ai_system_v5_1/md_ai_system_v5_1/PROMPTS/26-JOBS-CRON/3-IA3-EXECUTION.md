...
CATÉGORIE: `26-JOBS-CRON`

PÉRIMÈTRE
Seulement si demandé : tâches planifiées, queues, retries, idempotence, verrouillage, logs, alertes et reprise après échec.
...
- `.md-ai-system/state/26-JOBS-CRON.json`
