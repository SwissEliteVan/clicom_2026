...
CATÉGORIE: `38-CROSS-BROWSER`

PÉRIMÈTRE
Tester les navigateurs réellement ciblés par les `.md` : rendu, navigation, formulaires, médias, motion, stockage, consentement et fonctions critiques.
...
- `.md-ai-system/state/38-CROSS-BROWSER.json`
