...
CATÉGORIE: `22-BOT-WHATSAPP`

PÉRIMÈTRE
Seulement si demandé : bot/chat et WhatsApp. Vérifier desktop/mobile, clavier, focus, ouverture/fermeture, z-index, collisions avec consentement/CTA, fallback externe, aucun faux humain ni promesse inventée.
...
- `.md-ai-system/state/22-BOT-WHATSAPP.json`
