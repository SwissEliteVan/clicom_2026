...
CATÉGORIE: `49-RELEASE-VERSIONING-CHANGELOG`

PÉRIMÈTRE
Maintenir version projet, changelog, release notes, checkpoint de production, commit de référence, tag uniquement si la politique Git l'autorise et preuve de déploiement.
...
- `.md-ai-system/state/49-RELEASE-VERSIONING-CHANGELOG.json`
