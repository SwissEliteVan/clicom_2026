...
CATÉGORIE: `42-SUPPORT-CUSTOMER-SUCCESS`

PÉRIMÈTRE
Si applicable : centre d'aide, contact support, SLA si documenté, chatbot réellement utile, escalade vers humain, messages d'erreur et suivi après demande/conversion.

DÉPENDANCES RÉELLES
21-POST-CONVERSION-RETENTION, 40-ERRORS-RESILIENCE
...
- `.md-ai-system/state/42-SUPPORT-CUSTOMER-SUCCESS.json`
