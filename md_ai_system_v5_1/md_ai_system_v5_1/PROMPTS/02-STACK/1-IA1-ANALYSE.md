...
PÉRIMÈTRE
Proposer la stack idéale depuis les besoins réels, sans framework imposé. Évaluer si pertinent : frontend, backend, langage, package manager, DB, ORM, auth, stockage, email, API, CMS, paiements, analytics, monitoring, tests, CI/CD, hébergement, secrets, SEO, images, UI, motion, formulaires, validation, sécurité, i18n. Verrouiller les commandes exactes dev/lint/typecheck/test/build/e2e disponibles.
...
- `.md-ai-system/state/02-STACK.json`
