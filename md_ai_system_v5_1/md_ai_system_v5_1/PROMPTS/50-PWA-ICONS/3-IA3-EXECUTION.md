# PWA / ICÔNES OPTIONNELS

ÉTAPE: `3-IA3-EXECUTION.md`
CATÉGORIE: `50-PWA-ICONS`

PÉRIMÈTRE
Seulement si utile ou demandé : favicon.ico, fallback PNG, Apple Touch Icon, manifest PWA, icônes 192/512, theme color et installabilité.

DÉPENDANCES RÉELLES
13-DESIGN-NAVIGATION
...
- `.md-ai-system/state/50-PWA-ICONS.json`
