...
CATÉGORIE: `10-BACKUP-RESTORE`

PÉRIMÈTRE
Si applicable : sauvegarde/restauration DB, fichiers, uploads, stockage objet et configuration critique. Documenter fréquence, rétention, chiffrement, procédure de restauration et test réel de restauration. Inclure disaster recovery selon le risque.
...
- `.md-ai-system/state/10-BACKUP-RESTORE.json`
