...
CATÉGORIE: `31-ACCESSIBILITY`

PÉRIMÈTRE
Contrôler WCAG AA : clavier, focus visible, contrastes, labels, formulaires, ARIA, headings, ALT, reduced-motion, cibles tactiles, menus, modales, bot, WhatsApp, médias, consentement et popups.

DÉPENDANCES RÉELLES
13-DESIGN-NAVIGATION, 17-MEDIA-HERO-IMAGES-BLOG, 27-COOKIE-CONSENT-PRIVACY
...
- `.md-ai-system/state/31-ACCESSIBILITY.json`
