# POST-CONVERSION / FIDÉLISATION

ÉTAPE: `1-IA1-ANALYSE.md`
CATÉGORIE: `21-POST-CONVERSION-RETENTION`

PÉRIMÈTRE
Si applicable : confirmation, onboarding, email de suivi, upsell/cross-sell, demande d'avis réelle, referral, fidélisation et réactivation. Le funnel ne s'arrête pas au formulaire.
...
- `.md-ai-system/state/21-POST-CONVERSION-RETENTION.json`
