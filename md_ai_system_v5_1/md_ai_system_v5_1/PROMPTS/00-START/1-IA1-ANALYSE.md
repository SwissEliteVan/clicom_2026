# DÉMARRAGE / LECTURE MD

ÉTAPE: `1-IA1-ANALYSE.md`
CATÉGORIE: `00-START`

PÉRIMÈTRE
Trouver le point d'entrée documentaire sans scanner tout le dépôt. Lire README/INDEX/START s'ils existent, localiser SOURCE OF TRUTH, suivre leurs références, identifier les documents actifs et établir l'ordre de travail. Ne proposer aucune stack ici.
...
- `.md-ai-system/state/00-START.json`
