...
CATÉGORIE: `23-INTEGRATIONS`

PÉRIMÈTRE
Pour chaque service documenté : configuration, permissions minimales, variables d'environnement, erreurs, timeout, retry/fallback, webhooks, consentement et observabilité.
...
- `.md-ai-system/state/23-INTEGRATIONS.json`
