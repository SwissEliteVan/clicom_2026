...
CATÉGORIE: `05-DATA-BACKEND-AUTH`

PÉRIMÈTRE
Seulement si nécessaire : modèles, migrations, API, permissions, sessions/auth, validation, transactions et stratégie de migration. Les migrations destructives suivent le contrôle de risque renforcé. Aucun backend/auth/DB si les `.md` n'en ont pas besoin.
...
- `.md-ai-system/state/05-DATA-BACKEND-AUTH.json`
