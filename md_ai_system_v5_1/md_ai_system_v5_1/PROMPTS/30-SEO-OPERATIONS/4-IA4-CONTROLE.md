# SEO OPÉRATIONNEL APRÈS MISE EN LIGNE

ÉTAPE: `4-IA4-CONTROLE.md`
CATÉGORIE: `30-SEO-OPERATIONS`

PÉRIMÈTRE
Si applicable : Search Console, Bing Webmaster si utile, soumission sitemap, vérification indexation réelle, erreurs de couverture, Core Web Vitals terrain, redirections après migration et monitoring SEO.
...
- `.md-ai-system/state/30-SEO-OPERATIONS.json`
