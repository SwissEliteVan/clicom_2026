...
CATÉGORIE: `06-SAAS-LIFECYCLE`

PÉRIMÈTRE
Pour profil SaaS : onboarding, comptes, rôles, invitations, abonnement, factures, essais, résiliation, export/suppression des données, états d'échec et cohérence avec auth/paiements/privacy.
...
- `.md-ai-system/state/06-SAAS-LIFECYCLE.json`
