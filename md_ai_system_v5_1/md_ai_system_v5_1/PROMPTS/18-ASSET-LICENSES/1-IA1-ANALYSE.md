...
CATÉGORIE: `18-ASSET-LICENSES`

PÉRIMÈTRE
Auditer licences et droits des images, vidéos, polices, icônes, audio, modèles 3D et dépendances utilisées. Relier les décisions média au MEDIA-MANIFEST.

DÉPENDANCES RÉELLES
17-MEDIA-HERO-IMAGES-BLOG
...
- `.md-ai-system/state/18-ASSET-LICENSES.json`
