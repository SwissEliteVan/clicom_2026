...
CATÉGORIE: `40-ERRORS-RESILIENCE`

PÉRIMÈTRE
Vérifier 404, 500/error boundaries, erreurs runtime, états vides, timeouts, retries utiles, dégradation propre des intégrations et messages utilisateur.
...
- `.md-ai-system/state/40-ERRORS-RESILIENCE.json`
