...
CATÉGORIE: `41-CONTENT-GOVERNANCE`

PÉRIMÈTRE
Si applicable : définir qui modifie quoi, publication/dépublication, pages obsolètes, contenu expiré, dates de révision, auteurs, CMS, contrôle des liens et médias associés.
...
- `.md-ai-system/state/41-CONTENT-GOVERNANCE.json`
