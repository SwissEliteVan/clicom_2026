...
CATÉGORIE: `07-ECOMMERCE-LIFECYCLE`

PÉRIMÈTRE
Pour profil e-commerce : catalogue, stock, panier, checkout, paiement, livraison, taxes, retours, remboursements, paniers abandonnés et emails transactionnels.
...
- `.md-ai-system/state/07-ECOMMERCE-LIFECYCLE.json`
