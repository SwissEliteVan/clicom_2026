...
CATÉGORIE: `48-INCIDENT-RESPONSE`

PÉRIMÈTRE
Définir incident production, procédure de diagnostic, classification, rollback, restauration, communication, post-mortem, disponibilité et dépendances critiques. Ne pas inventer de SLA.

DÉPENDANCES RÉELLES
10-BACKUP-RESTORE, 36-HEALTH-UPTIME, 47-STAGING-DEPLOY
...
- `.md-ai-system/state/48-INCIDENT-RESPONSE.json`
