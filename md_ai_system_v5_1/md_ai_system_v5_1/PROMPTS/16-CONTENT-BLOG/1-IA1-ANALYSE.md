...
CATÉGORIE: `16-CONTENT-BLOG`

PÉRIMÈTRE
Implémenter le contenu réel des `.md`. Si blog : index, articles, catégories/tags si prévus, pagination si utile, données structurées, partage social, maillage interne et multilingue. Aucun contenu inventé présenté comme réel.
...
- `.md-ai-system/state/16-CONTENT-BLOG.json`
