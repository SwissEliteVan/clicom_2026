...
CATÉGORIE: `13-DESIGN-NAVIGATION`

PÉRIMÈTRE
Appliquer le design documenté. Vérifier header, menu desktop/mobile, footer, CTA, clavier, focus, liens actifs, ancres, scroll. Logo : sur l'accueil, clic = retour en haut ; depuis une autre page, clic = accueil.
...
- `.md-ai-system/state/13-DESIGN-NAVIGATION.json`
