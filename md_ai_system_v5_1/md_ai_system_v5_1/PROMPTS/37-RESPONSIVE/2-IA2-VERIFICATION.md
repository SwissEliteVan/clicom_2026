...
CATÉGORIE: `37-RESPONSIVE`

PÉRIMÈTRE
Tester réellement mobile, tablette et desktop : navigation, textes longs, langues longues, formulaires, consentement, bot, WhatsApp, médias, animations, tableaux, footer, menus, overflow, orientation et cibles tactiles.

DÉPENDANCES RÉELLES
13-DESIGN-NAVIGATION, 17-MEDIA-HERO-IMAGES-BLOG
...
- `.md-ai-system/state/37-RESPONSIVE.json`
